...
def main():
    ...
    print(f"\n--- Interpretation ---")
    if abs(r_delta) < 0.3:
        print("  WEAK correlation: delta-PAC is not strongly associated with delta-EMG.")
        print("  Treat this as diagnostic support, not definitive EMG separation evidence.")
    elif abs(r_delta) < 0.6:
        print("  MODERATE correlation: EMG may partly track the PAC finding.")
        print("  Review the EMG-corrected PAC sensitivity output.")
    else:
        print("  STRONG correlation: EMG is a plausible contributor to PAC change.")
        print("  Review the EMG-corrected PAC sensitivity output before interpretation.")
